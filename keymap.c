...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
  [_QWERTY] = LAYOUT(
    KC_GRV,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,   TO_LO,            XXXXXXX, KC_Y,   KC_U,   KC_I,    KC_O,    KC_P,    KC_MINS, \
    M_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,   XXXXXXX,          XXXXXXX, KC_H,   KC_J,   KC_K,    KC_L,    KC_SCLN, KC_QUOT, \
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,   XXXXXXX,          XXXXXXX, KC_N,   KC_M,   KC_COMM, KC_DOT,  KC_SLSH, KC_EQL, \
    KC_LCTL, KC_LGUI, KC_LALT, KC_LCTL,  LOWER,   KC_SPC, XXXXXXX,          XXXXXXX, KC_ENT, RAISE,  KC_LSFT,  KC_LALT , KC_APP,  KC_LCTL \
  ),
   ...
   */
  [_LOWER] = LAYOUT(
  	KC_ESC,  XXXXXXX, KC_PGUP, KC_UP,   KC_PGDN,  XXXXXXX, TO_QW,            XXXXXXX, XXXXXXX, L_DESC,  M_TASK,  R_DESC, XXXXXXX, KC_PSCR, \
    KC_TAB,  KC_HOME, KC_LEFT, KC_DOWN, KC_RGHT, KC_END,  XXXXXXX,          XXXXXXX, XXXXXXX, KC_LALT, KC_LSFT, KC_LCTL, KC_LGUI, XXXXXXX, \
    _______,  KC_TAB, KC_BSPC, KC_DEL,  KC_ESC,   XXXXXXX,  XXXXXXX,          XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX,  XXXXXXX, XXXXXXX, XXXXXXX, \
    _______,  _______, _______, _______, LOWER,   KC_LALT, XXXXXXX,          XXXXXXX, SFT_ENT, RAISE,   _______, XXXXXXX, XXXXXXX, XXXXXXX \
  ), 

  [_CAPS] = LAYOUT(
    XXXXXXX, P_TOYS,  XXXXXXX, KC_END,  R_DESC,  XXXXXXX, XXXXXXX,          XXXXXXX, XXXXXXX, XXXXXXX, KC_TAB,  XXXXXXX, KC_UP,   XXXXXXX, \
  ...
  */
  [_RAISE] = LAYOUT(
    KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KVM_1,            KVM_2, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_UNDS, \
    KC_PIPE, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KVM_3,            KVM_4, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_DQT, \
    KC_BSLS, KC_LCBR, KC_RCBR, KC_LBRC, KC_RBRC, KC_COLN, XXXXXXX,          XXXXXXX, XXXXXXX, KC_COLN, KC_LT, KC_GT, KC_QUES, KC_PLUS, \
   ...
   */
  [_ADJUST] = LAYOUT(
  	P_TOYS, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,          XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
  	XXXXXXX, KC_LGUI, KC_LCTL, KC_LSFT, KC_LALT, XXXXXXX, XXXXXXX,          XXXXXXX, XXXXXXX, KC_LALT, KC_LSFT, KC_LCTL, KC_LGUI, XXXXXXX, \
